...
public class H5Star extends JFrame implements ActionListener
{
	...
	public H5Star()
	{
		super("Payment of 5 Star Hotel Provider Vendor");
            ...
            if(!cn.isEmpty()&&!ch.isEmpty()&&!ed.isEmpty()&&!cvv.isEmpty())
				{
                    ...
                    try
					{
                        writer=new FileWriter("Data/H5PaymentInfo.txt",true);
