...
public class AddAdmin extends JFrame implements ActionListener
{
	...
	public AddAdmin()
	{
		...
		img = new ImageIcon(getClass().getResource("Pic/Admin.png"));
		...
		tf = new JTextField();
        tf.setBounds(345, 75, 270, 40);
        
		
		label1 = new JLabel();
        label1.setText("Enter Your Password    :");
        label1.setBounds(165, 130, 200, 40);
		...
		tf1 = new JTextField();
        tf1.setBounds(345, 130, 270, 40);
        
		
		label2 = new JLabel();
        label2.setText("Enter Your Name		:");
        label2.setBounds(165, 185, 200, 40);
            ...
            if(!email.isEmpty()&&!password.isEmpty()&&!name.isEmpty()&&!phone.isEmpty()&&!nid.isEmpty()&&!balance.isEmpty())
				{
                    ...
                    try
					{
                        writer=new FileWriter("Data/UserInfo.txt",true);
