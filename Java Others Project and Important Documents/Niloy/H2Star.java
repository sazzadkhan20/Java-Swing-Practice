...
public class H2Star extends JFrame implements ActionListener
{
	...
	public H2Star()
	{
		super("Payment of 2 Star Hotel Provider Vendor");
		
		img = new ImageIcon(getClass().getResource("Pic/payment.png"));
		BackgroundImage = new JLabel (img);
		BackgroundImage.setBounds(0,0,img.getIconWidth(),img.getIconHeight());
		
		img1 = new ImageIcon(getClass().getResource("Pic/VisaCard.png"));
        imgLabel = new JLabel(img1);
        imgLabel.setBounds(300, 40, img1.getIconWidth(), img1.getIconHeight());
        add(imgLabel);
		
		img2 = new ImageIcon(getClass().getResource("Pic/MasterCard.png"));
            ...
            if(!cn.isEmpty()&&!ch.isEmpty()&&!ed.isEmpty()&&!cvv.isEmpty())
				{
                    ...
                    try
					{
                        writer=new FileWriter("Data/H2PaymentInfo.txt",true);
