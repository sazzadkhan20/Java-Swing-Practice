...
public class UserList extends JFrame implements ActionListener
{
	...
	public UserList()
	{
        ...
        try 
		{
            reader = new FileReader("Data/UserInfo.txt");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			if (table.getSelectionRows().length>0) 
				{
				...
				if(selectedRows!=null){
					for(int i=selectedRows.length-1; i>=0 ;i--){
						...
						File oldFile = new File("Data/UserInfo.txt");
				...
				//pw.close();
				oldfile.delete();
				File dump=new File("Data/UserInfo.txt");
