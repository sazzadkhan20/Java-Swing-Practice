...
public class TransportationPricing extends JFrame implements ActionListener
{
	...
	private String[] column = {"Place", "Feature", "Price"};
	private String[] column1 = {"Place", "Feature", "Price"};
	private String[] column2 = {"Place", "Feature", "Price"};
	...
	public TransportationPricing()
	{
        ...
        try 
		{
            reader = new FileReader("Data/AirService.txt");
            ...
            Places = new String[Number_of_Lines];
            Features = new String[Number_of_Lines];
		...
		{
            rows[0] = Places[i]; // Place
            rows[1] = Features[i]; // Feature
            rows[2] = Prices[i]; // Price
            model.addRow(rows);
        }
		
		//table 2
		label1 = new JLabel("Transportation Vendor(Bus)");
        label1.setBounds(390, 150, 200, 30);
        ...
        try 
		{
            reader = new FileReader("Data/BusService.txt");
            bfreader = new BufferedReader(reader);
            ...
            // initialize arrays with appropriate size
            Places = new String[bNumber_of_Lines];
            Features = new String[bNumber_of_Lines];
        ...
        label2.setBounds(390, 294, 200, 30);
        ...
        try 
		{
            reader = new FileReader("Data/TrainService.txt");
            bfreader = new BufferedReader(reader);
            ...
            // initialize arrays with appropriate size
            Places = new String[tNumber_of_Lines];
            Features = new String[tNumber_of_Lines];
