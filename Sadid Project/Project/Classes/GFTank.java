...
public class GFTank extends JFrame implements ActionListener
{
    ...
    //JLabel			
		...
		l3 = new JLabel("12*24 inch Glass fish tank");
		...
		l5 = new JLabel("10 Gallon fish tank");
		...
		l6 = new JLabel("Small size fish tank");
		...
		l1 = new JLabel("Bowl shape fish tank");
